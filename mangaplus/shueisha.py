...
class MangaPlus:
    ...
    def __clang(self) -> str:
        ...
        assert all(isinstance(lang_item, Language) for lang_item in self.clang), 'All elements must be instances of Language'
        return ','.join([lang_item.value for lang_item in self.clang])
